...
<body>
  <section class="ui-wrapper">
    ...
    <div class="content-area">
      ...
      <select name='subject' class="dropdown-orange">
      ...
      <ul class="select">
        <li class="selection">
          <input type="radio" id="a-option" name="type" checked="checked">
      ...
      <ul class="select">
        <li class="selection">
          <input type="radio" id="a-option" name="amount" checked="checked">
          <label for="a-option">แบบเดี่ยว</label>
        </li>
        <li class="selection">
          <input type="radio" id="b-option" name="amount">
